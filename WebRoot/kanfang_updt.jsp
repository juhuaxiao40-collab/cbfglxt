...
<div style="padding: 10px" class="admin-content">
    <div class="card">
        ...
        <div class="card-body">
            <form action="kanfangupdate.do" method="post" id="form">
                ...
                <div class="form-group">
                    <label>看房时间</label>
                    <input type="text" class="form-control Wdate" name="kanfangshijian" id="kanfangshijian" value="${mmm.kanfangshijian}" onclick="WdatePicker()" placeholder="请选择看房时间">
                </div>
