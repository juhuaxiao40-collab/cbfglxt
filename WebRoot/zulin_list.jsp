                ...
                <table width="100%" border="1" class="table">
                    ...
                    <c:set var="i" value="0"/><c:forEach items="${list}" var="map"><c:set var="i" value="${i+1}"/>
                        <tr id="${map.id}" pid="">
                            ...
                            <td align="center">
                                <a href="feiyong_add.do?id=${map.id}" class="btn btn-default">添加费用</a>
                                <a href="feiyong_list.do?zulinid=${map.id}" class="btn btn-default">查询费用</a>
                                <a href="jieyue_add.do?id=${map.id}" class="btn btn-default">添加解约</a>
                                <a href="jieyue_list.do?zulinid=${map.id}" class="btn btn-default">查询解约</a>
                                <a href="fuwu_add.do?id=${map.id}" class="btn btn-default">添加服务</a>
                                ...
                                <a href="zulin_updt.do?id=${map.id}" class="btn btn-default">编辑</a>
                                <a href="zulindelete.do?id=${map.id}" onclick="return confirm('确定要删除？')"
