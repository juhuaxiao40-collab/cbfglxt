...
<div style="padding: 10px" class="admin-content">
    ...
    <div>
        <div class="card">
            <div class="card-header">编辑 用户:</div>
            <div class="card-body">
                <form action="yonghuupdate.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_cx" name="cx" id="cx" data-value="${Info.html(mmm.cx)}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="输入用户名" style="width:300px;"
                               ...
                               data-msg-remote="内容重复了" id="yonghuming" name="yonghuming"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_xingbie" name="xingbie" id="xingbie"
                                data-value="${Info.html(mmm.xingbie)}" data-rule-required="true"
                                data-msg-required="请选择性别" style="width:250px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="输入手机号" style="width:300px;"
                               ...
                               data-msg-phone="请输入正确手机号码" id="shoujihao" name="shoujihao"
                               value="${Info.html(mmm.shoujihao)}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="输入邮箱" style="width:300px;"
                               ...
                               data-msg-email="请输入正确邮箱" id="email" name="email"
